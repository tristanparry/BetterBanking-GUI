...
public class ManipulateAccount_GUI implements ActionListener {
	 ...
	 */
	public ManipulateAccount_GUI(Client clientArg, Account accountArg) {
		this.c = clientArg;
		this.a = accountArg;
	...
	public void actionPerformed(ActionEvent ae) {		
		...
		if (ae.getSource() == this.depositPanelButton) {
			this.a.deposit(Utilities.readDoubleFrom(this.depositPanelField));
		}
		if (ae.getSource() == this.withdrawButton) {
			switchJPanel(this.withdrawPanel);
		}
		if (ae.getSource() == this.withdrawPanelButton) {
			this.a.withdraw(Utilities.readDoubleFrom(this.withdrawPanelField));
		}
		...
		if (ae.getSource() == this.moveMoneyPanelChequingButton) {
			...
			((Savings) this.a).moveMoney(Utilities.readDoubleFrom(this.moveMoneyPanelField), clientAccount);
		}
	...
	public static void manipulateAccount(Client clientArg, Account accountArg) {		
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				window = new ManipulateAccount_GUI(clientArg, accountArg);
